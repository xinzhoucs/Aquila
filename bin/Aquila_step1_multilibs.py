...
def main():
    if len(sys.argv) == 1:
        ...
        pickle_dir = args.out_dir + "/pickle_files/"
        ...
        if os.path.exists(pickle_dir):
            print("using existing output folder: " + pickle_dir)
        else:
        ...
        mole_len_dict_prev_file = pickle_dir + "/mole_len_dict_prev_" + str(chr_start) + "_" + str(chr_end) + ".p"
        ...
        for _num in range(len(bam_list)):
            ...
            mole_len_dict_file = pickle_dir + "/mole_len_dict_" + str(chr_start) + "_" + str(chr_end) + ".p"
